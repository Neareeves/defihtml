...
<head>
		...
		<title>Balise &lsaquo;table&rsaquo;</title>
...
<body>
	<header>
		<div id="conteneur">
			...
			<div class="titrepage"><h1>Les balises HTML</h1></div>
			<div class="logogroupe"><img src="logoGroupe100.png" alt="logo de la meilleure équipe"></div>
		</div>
	...
	<nav>
		<ul>
			<li class="menu-block"><a href="block.html">Balises block</a>
			...
			<li class="menu-inline"><a href="inline.html">Balises inline</a>
			...
			<li class="menu-speciales"><a href="menu-speciales">Balises spéciales</a>
	...
	<!-- <img src="logoGroupe50.png" alt="logo de la meilleure équipe"> -->
		<!-- Menu déroulant, nom du site -->

	</header>
	
		<main>

			<h2 class="letitre">La balise &lsaquo;table&rsaquo;
			</h2>
			...
			<article>
				...
				<!-- <h3 class="titredefinition">Définition</h3> -->
					<div class="leschevrons">
						<p class="textecourant">La balise &lsaquo;table&rsaquo; permet de représenter un tableau de données, c'est-à-dire des informations exprimées sur un tableau en deux dimensions.Il est nécessaire d'utiliser au minimum les balises &lsaquo;tr&rsaquo; (nouvelle ligne) et &lsaquo;td&rsaquo; (nouvelle colonne) pour mettre en forme les éléments à afficher dans la table.</p>
					</div>
				<div class="exemples">
					<h4>Exemple : </h4>

					<div>
					Voilà du code utilisant la balise &lsaquo;table&rsaquo; pour créer un tableau.
					</div>

					<br>

					<img src="table1.png" alt="Le code pour mon tableau">
					...
					<img src="table2.png" alt="La capture d'écran de mon tableau">	
				</div>	
			</article>
		</main>
	<footer>
		...
		<div id ="logoAHC">
			...
			<div class="retourAccueil"> <a href="accueil.html"><img src="boutonRetour2.png" alt="Accueil" title="ACCUEIL"> </a></div>
		</div>
